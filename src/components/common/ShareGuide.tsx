...
export const ShareGuide: React.FC<ShareGuideProps> = ({ title = "Share", pageTitle, description, className = "" }) => {
    ...
    return (
        <div className={`flex items-center justify-center gap-2 sm:gap-4 py-2 px-3 sm:py-3 sm:px-8 rounded-full bg-gradient-to-r from-[#ff9248] to-[#ff7033] text-white shadow-xl border border-white/20 ${className}`}>
            <span className="hidden min-[400px]:inline-block text-[10px] sm:text-xs font-black uppercase tracking-[0.1em] sm:tracking-[0.2em] text-white/90 drop-shadow-sm">{title}</span>
                      <div className="flex items-center gap-2 sm:gap-4">
                {/* WhatsApp */}
                <button
                    type="button"
                    className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center rounded-full bg-white text-[#25D366] shadow-md transition-all duration-300 hover:scale-110 hover:bg-[#25D366] hover:text-white hover:shadow-[0_0_20px_rgba(37,211,102,0.6)]"
                ...
                <button
                    type="button"
                    className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center rounded-full bg-white text-[#1877F2] shadow-md transition-all duration-300 hover:scale-110 hover:bg-[#1877F2] hover:text-white hover:shadow-[0_0_20px_rgba(24,119,242,0.6)]"
                ...
                <button
                    type="button"
                    className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center rounded-full bg-white text-[#0A66C2] shadow-md transition-all duration-300 hover:scale-110 hover:bg-[#0A66C2] hover:text-white hover:shadow-[0_0_20px_rgba(10,102,194,0.6)]"
                ...
                <button
                    type="button"
                    className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center rounded-full bg-white text-[#E4405F] shadow-md transition-all duration-300 hover:scale-110 hover:bg-[#E4405F] hover:text-white hover:shadow-[0_0_20px_rgba(228,64,95,0.6)]"
                ...
                <button
                    type="button"
                    className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center rounded-full bg-white text-black shadow-md transition-all duration-300 hover:scale-110 hover:bg-black hover:text-white hover:shadow-[0_0_20px_rgba(0,0,0,0.3)]"
                ...
                <button
                    type="button"
                    className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center rounded-full bg-white text-slate-500 shadow-md transition-all duration-300 hover:scale-110 hover:bg-slate-500 hover:text-white hover:shadow-[0_0_20px_rgba(148,163,184,0.4)]"
